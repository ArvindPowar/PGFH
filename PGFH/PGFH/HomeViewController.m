   ...
   if([elementName isEqualToString:@"feedtype"]){
        ...
        if ([mainFeedVO.feedType isEqualToString:@"foodpost"]) {
            if([elementName isEqualToString:@"feedtype"]){
                ...
                if (![currentElementData isEqualToString:@""] && !(currentElementData ==nil)) {
    ...
    if ([mainFeedVO.feedType isEqualToString:@"foodpost"]) {
        ...
        if(![newpostVO.restaurantname isEqualToString:@""]){
         ...
         cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([mVO.feedType isEqualToString:@"foodpost"]) {
       ...
       cell.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"navigationbar.png"]];
        ...
        int value;
        value=[self textViewHeightForAttributedText:[[NSAttributedString alloc] initWithString :annVO.descriptionS] andWidth:self.view.bounds.size.width-100]+60;
        UILabel *cmtTextView=[[UILabel alloc] initWithFrame:CGRectMake(115,30,210,[self textViewHeightForAttributedText:[[NSAttributedString alloc] initWithString :annVO.descriptionS] andWidth:self.view.bounds.size.width-100]+60)];
        ...
        cmtTextView.textAlignment = NSTextAlignmentCenter;
       // [cmtTextView sizeToFit];
