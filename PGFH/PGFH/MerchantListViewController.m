         ...
         cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.backgroundColor=[UIColor clearColor];
        ...
        merchantNameTextview=[[UILabel alloc] initWithFrame:CGRectMake(5, 0, self.view.bounds.size.width-5, 25)];
        ...
        merchantDescriptionTextview=[[UILabel alloc] initWithFrame:CGRectMake(5,15, self.view.bounds.size.width-5, [self textViewHeightForAttributedText:[[NSAttributedString alloc] initWithString :merchant.merchantdescription] andWidth:self.view.bounds.size.width-60]+50)];
